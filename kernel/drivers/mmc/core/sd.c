...
int mmc_attach_sd(struct mmc_host *host)
{
	...
	while (retries) {
		...
		if (err) {
			retries--;
/* LGE_CHANGE_S :Not able to detect some local SD cards 
 *               2012-08-06, jyothishre.nk@lge.com
 */
	...
	To fix this, call mmc_power_up() and mmc_select_voltage() before retrying.
	*/
...
/*LGE_CHANGE_E:Not able to detect some local SD cards*/
	if (!retries) {
