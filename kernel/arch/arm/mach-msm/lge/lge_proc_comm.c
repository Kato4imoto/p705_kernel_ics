 ...
 * read write nv items not using qcril */
#if defined (CONFIG_LGE_HANDLE_NV_NOT_QCRIL)

#define CUSTOMER_CMD2_GET_FRSTSTATUS		0x15
#define CUSTOMER_CMD2_SET_FRSTSTATUS		0x16
...
#endif /* CONFIG_LGE_HANDLE_NV_NOT_QCRIL */
/* LGE_UPDATE_E */
